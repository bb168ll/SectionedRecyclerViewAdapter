...
public abstract class Section<T> {
    ...
    public Section(SectionParameters sectionParameters) {
        ...
        if (sectionParameters.mDatas == null) {
            this.mDatas = new ArrayList<T>();
        } else {
            this.mDatas = sectionParameters.mDatas;
        }

        this.mHeadTitle = sectionParameters.mTitle;
    }
    ...
    public final void onBindContentViewHolder(ViewHolder holder, int position) {
        switch (state) {
            case LOADING:
                ...
                break;
            case LOADED:
                onBindItemViewHolder(holder, mDatas.get(position), position);
                break;
            case FAILED:
...
//    }
     ...
     * @param position position of the item in the Section, not in the RecyclerView
     */
    public abstract void onBindItemViewHolder(ViewHolder holder, T t, int position);
