...
import io.github.luizgrp.sectionedrecyclerviewadapter2.sectionedrecyclerviewadapter.Section.State;
...
//        return section.getItemViewHolder(view);
    ...
    private ViewHolder getHeaderViewHolder(ViewGroup parent, Section section) {
        ...
        return ViewHolder.createViewHolder(parent.getContext(), parent, resId);
    }
